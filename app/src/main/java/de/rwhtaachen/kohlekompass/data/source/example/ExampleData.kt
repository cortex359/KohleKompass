...
val transactionList = mutableListOf(
    Transaction(
        ...
        amount = Money(35.00),
        user = userList[0],
        valueDate = LocalDate.of(2023, Month.JUNE, 24),
        localDate = LocalDate.of(2023, Month.JUNE, 24),
        syncDate = LocalDate.of(2023, Month.JUNE, 24),
        ...
        amount = Money(65.50),
        user = userList[1],
        valueDate = LocalDate.of(2023, Month.JUNE, 27),
        localDate = LocalDate.of(2023, Month.JUNE, 27),
        syncDate = LocalDate.of(2023, Month.JUNE, 27),
        tags = mutableSetOf(tags["dining"]!!)
    ), Transaction(
        title = "Grocery shopping",
        amount = Money(55.75),
        ...
        amount = Money(85.25),
        user = userList[1],
        valueDate = LocalDate.of(2023, Month.JUNE, 23),
        localDate = LocalDate.of(2023, Month.JUNE, 23),
        syncDate = LocalDate.of(2023, Month.JUNE, 23),
        tags = mutableSetOf(tags["dining"]!!)
    ), Transaction(
        title = "Grocery shopping",
        amount = Money(60.40),
        ...
        amount = Money(70.15),
        user = userList[3],
        valueDate = LocalDate.of(2023, Month.JULY, 2),
        localDate = LocalDate.of(2023, Month.JULY, 2),
        syncDate = LocalDate.of(2023, Month.JULY, 2),
        tags = mutableSetOf(tags["groceries"]!!)
    ), Transaction(
        title = "Haircare products",
        amount = Money(25.50),
        user = userList[0],
        valueDate = LocalDate.of(2023, Month.JULY, 9),
        localDate = LocalDate.of(2023, Month.JULY, 9),
        syncDate = LocalDate.of(2023, Month.JULY, 9),
        tags = mutableSetOf(tags["personal care"]!!)
    ), Transaction(
        title = "Monthly rent",
        amount = Money(1200.00),
